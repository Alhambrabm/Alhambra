...
<head>
    ...
    <style>
        ...
        .menu-item-row {
            ...
            display: flex; /* Asegura el layout flex para móvil */
            flex-direction: column; /* Apila nombre y precio en móvil */
            padding-top: 1rem;
            padding-bottom: 1rem;
        }
        .menu-item-row:hover {
            background-color: #fff7ed; /* Naranja muy suave al pasar el mouse */
        }
        .menu-item-content {
            display: flex;
            justify-content: space-between;
            align-items: flex-start; /* Alinea los ítems de arriba */
            width: 100%;
        }
    </style>
</head>
<body class="font-sans dynamic-bg text-gray-800">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 sm:p-10 rounded-2xl shadow-2xl border-4 border-orange-100 space-y-4">
                ...
                <div>
                    ...
                    <ul class="divide-y divide-gray-200">
                        ...
                        <li class="menu-item-row">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Bife de lomo cubierto con abundante salsa cheddar y tiras de panceta crocante.</p>
                        </li>
                        <!-- Lomito caramelizado -->
                        <li class="menu-item-row">
                            <div class="menu-item-content">
                ...
                <div>
                    ...
                    <p class="text-gray-500 mb-4 text-sm font-medium">Milanesas caseras, bien crujientes y sabrosas.</p>
                    ...
                    <ul class="divide-y divide-gray-200">
                        ...
                        <li class="menu-item-row">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Milanesa de ternera/pollo (especificar) rebozada a mano, con lechuga y tomate.</p>
                        </li>
                        <!-- Mila completa -->
                        <li class="menu-item-row">
                            <div class="menu-item-content">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Nuestra mila crujiente con jamón, queso, huevo frito y todos los vegetales frescos.</p>
                        </li>
                        <!-- Mila cheddar -->
                        <li class="menu-item-row">
                            <div class="menu-item-content">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Milanesa cubierta en abundante salsa cheddar caliente y panceta ahumada.</p>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    <!-- Título con línea fuerte -->
                    <h3 class="title-line text-3xl font-extrabold text-primary-orange mb-4 pb-1">HAMBURGUESAS</h3>
                    ...
                    <ul class="divide-y divide-gray-200">
                        ...
                        <li class="menu-item-row">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Medallón de carne de 120gr, lechuga, tomate y aderezos en pan de sésamo.</p>
                        </li>
    ...
    <section id="promos" class="py-16 bg-primary-orange text-soft-white shadow-inner">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="title-line text-soft-white text-4xl sm:text-5xl font-bold mb-12 mx-auto text-center">
                Promociones
            </h2>
            
            <!-- Contenedor de Promos -->
            <div class="bg-white p-6 sm:p-10 rounded-2xl shadow-2xl border-4 border-accent-orange text-gray-900">
                <p class="text-xl font-bold text-center mb-6 text-primary-orange">¡Dúos imbatibles para compartir!</p>

                <ul class="divide-y divide-orange-200">
                    <li class="menu-item-row flex justify-between items-center py-3">
                        <span class="text-lg font-medium">2 lomitos simples</span>
                        <span class="text-xl font-bold text-primary-orange">$10.000</span>
                    </li>
                    <li class="menu-item-row flex justify-between items-center py-3">
                        <span class="text-lg font-medium">2 lomitos especiales (completo, cheddar o caramelizado)</span>
                        <span class="text-xl font-bold text-primary-orange">$12.000</span>
                    </li>
                    <li class="menu-item-row flex justify-between items-center py-3">
                        <span class="text-lg font-medium">2 milas comunes (simple)</span>
                        <span class="text-xl font-bold text-primary-orange">$9.000</span>
                    </li>
                    <li class="menu-item-row flex justify-between items-center py-3">
                        <span class="text-lg font-medium">2 milas especiales (completa o cheddar)</span>
                        <span class="text-xl font-bold text-primary-orange">$11.000</span>
                    </li>
                </ul>
            </div>
    ...
    <section id="contacto" class="py-16 bg-gray-100">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">
                Llamá y retiramos tu orden lista y caliente.
            </p>
            
            <div class="flex flex-col space-y-4">
                <!-- Teléfono Actualizado -->
                <a href="tel:3855393742" class="inline-flex items-center justify-center bg-primary-orange hover:bg-accent-orange text-white text-lg font-bold py-3 px-8 rounded-xl transition duration-300 shadow-md">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                    Llamar: 385 539 3742
                </a>
                <p class="text-gray-500 pt-2">
                    Av. Dirección de Ejemplo 4567, Ciudad
                </p>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 text-gray-300 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm">
            &copy; 2024 Sandwichería La Alhambra | Creado para Canvas.
        </div>
    </footer>
